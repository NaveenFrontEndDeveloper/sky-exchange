...
<div class="announce-wrap login-policy" >
	...
	<div class="tc-content mt-5 d-inline-block font-14" style="padding: 15px;">
		...
		<p>This Privacy Policy explains how Skyexch.art uses your personal information when you are using one of
			our website.</p>
		...
		<p>
			Throughout this Privacy Policy, " Skyexch.art", "we", "our" and "us" relates to Sky Infotech N.V., a
			...
			purposes for which your Personal Data is used by Skyexch.art, acting as the “data controller” for the
		...
		<p>
			If you have concerns or would like any further information about how Skyexch.art handles your personal
			information, you can contact our Data Protection Officer at <a href="mailto:support@skyexch">support@skyexch.in</a>.
		</p>
		...
		<p>
			...
			chat rooms) Skyexch.art may store record or otherwise process this data.
		</p>
		
		<h3>Non-personally identifiable information and traffic analysis</h3>
		
		<p>
			Skyexch.art strives to make our website as user friendly as possible and easy to find on the Internet.
			Skyexch.art collects data on how you use the site, which does not identify you personally. When you
		...
		<p>
			Skyexch.art uses cookies to ensure our website works efficiently and to enhance your visits to our
		...
		<p>
			Skyexch.art will use your identification document and/or proof of address to check your details in order
		...
		<p>
			...
			live chat or by emailing <a href="mailto:support@skyexch.art">support@skyexch.art</a> and we will
		...
		<p>
			...
			In determining data retention periods, Skyexch.art takes into consideration local laws, contractual
		...
		<p>
			...
			collected to track and examine the use of Skyexch.art, to prepare reports on its activities and share
